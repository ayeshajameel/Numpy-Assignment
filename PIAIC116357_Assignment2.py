...
def function8():
    ...
    x = np.full((2,5),6, dtype=np.uint32) #write your code her
    return x
...
def function9():
    ...
    a= np.arange(2,100,2) # write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.repeat(arr,3),np.tile(arr,3)#write your code here 
...
def function14():
    ...
    ans = numpy.split(arr,4,axis=0) #write your code here 
